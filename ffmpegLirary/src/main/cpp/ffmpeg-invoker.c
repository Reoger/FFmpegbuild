...
Java_com_dayuwuxian_ffmpeg_FFmpegInvoker_exit(JNIEnv *env, jclass type) {
    (*env)->GetJavaVM(env, &jvm);
...
Java_com_dayuwuxian_ffmpeg_FFmpegInvoker_getConfigInfo(JNIEnv *env, jclass clazz) {
    char info[10000] = {0};
...
JNIEXPORT jstring JNICALL
Java_com_dayuwuxian_ffmpeg_FFmpegInvoker_getAVFormatInfo(JNIEnv *env, jclass clazz) {
    char info[40000] = { 0 };
...
JNIEXPORT jstring JNICALL
Java_com_dayuwuxian_ffmpeg_FFmpegInvoker_getAVFilterInfo(JNIEnv *env, jclass clazz) {
    char info[40000] = { 0 };
